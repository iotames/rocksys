...
func TestBuildServer(t *testing.T) {
	...
	s := string(def)
	for _, key := range []string{"DB_DSN", "CONF_DIR", "HOT_SCRIPTS_DIR", "HOT_FILES_WATCH_INTERVAL", "TRUSTED_PROXIES_FILE", "SCRIPT_TIMEOUT", "REGISTRY_ADDR", "REGISTRY_TTL", "OBJECT_BASE_DIR", "MQ_ENABLED", "MQ_POLL_INTERVAL", "MQ_MAX_RETRIES", "MQ_BASE_BACKOFF", "MQ_CONSUMER_BASE_URL"} {
