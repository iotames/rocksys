...
(function () {
  ...
  // 11=人工收录置首（人工添加/导入默认选项）；0=其他为黑名单表存储兜底（查询语境 0=全部，筛选下拉须排除）
  const BLOCK_TYPES = [
    [11, '人工收录'], [1, 'IP黑名单'], [2, '限流'], [3, '方法不允许'], [4, '请求体超限'], [5, '风险路径'],
    [6, '路径遍历'], [7, 'SQL注入'], [8, 'XSS'], [9, '爬虫UA'], [10, '路径规则'], [0, '其他'],
  ];
  ...
  const TEXTAREA_KEYS = [
    'REWRITE_RULES', 'COPY_TARGETS', 'DB_DSN',
