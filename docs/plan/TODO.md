...
| 2 | TRAFFIC_ANALYSIS/STEP2_geoip包.md | internal/geoip 包（v2 依赖）+ GEOIP_MMDB_DIR 配置 + obs/shield 写时解析接线 | 1 | 待实施 |
| 3 | TRAFFIC_ANALYSIS/STEP3_统计SQL脚本.md | traffic_summary/series_hour/series_day/geo_top 三方言 + sqlite 单测 + 真库门控集成 | 1 | 待实施 |
